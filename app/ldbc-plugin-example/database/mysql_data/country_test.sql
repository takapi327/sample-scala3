...
--
-- Table structure for table `country_test`
--
...
CREATE TABLE `country_test` (
  `id` tinyint(255) NOT NULL AUTO_INCREMENT COMMENT '識別子',
  `code` char(3) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) CHARACTER SET big5 COLLATE big5_bin NOT NULL COMMENT 'name',
  `population` int(11) NOT NULL,
  `gnp` double DEFAULT NULL,
  `auto_inc_id` bigint(64) NOT NULL,
