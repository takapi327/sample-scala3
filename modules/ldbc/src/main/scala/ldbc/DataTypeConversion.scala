...
trait DataTypeConversion:
  ...
  given optionFloatDouble: Conversion[CFloat[Double], CFloatOpt[Option[Double]]] =
    v => CFloatOpt(v.accuracy, v.default)
  given optionFloatFloat: Conversion[CFloat[Float], CFloatOpt[Option[Float]]] =
    v => CFloatOpt(v.accuracy, v.default)

  given Conversion[CChar[String], CCharOpt[Option[String]]] =
    v => CCharOpt(v.length, v.default, v.character)
